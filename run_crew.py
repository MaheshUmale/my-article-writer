...
# --- NEW: Initialize the Google Gemini LLM and the Tavily Search Tool ---
# Make sure your .env file has GOOGLE_API_KEY and TAVILY_API_KEY
#llm = ChatGoogleGenerativeAI(model="gemini/gemini-2.5-pro")
